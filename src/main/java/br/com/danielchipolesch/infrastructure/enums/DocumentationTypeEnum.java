...
public enum DocumentationTypeEnum {
    ...
    DCA("Diretriz do Comando da Aeronáutica", "Espécie destinada, precipuamente,\n" +
    ...
    FCA("Folheto do Comando da Aeronáutica", "Espécie destinada a informar e a\n" +
    ...
    ICA("Instrução do Comando da Aeronáutica", "Espécie de caráter determinativo\n" +
    ...
    MCA("Manual do Comando da Aeronáutica", "Espécie de caráter diretivo,\n" +
    ...
    NSCA("Norma de Sistema do Comando da Aeronáutica", "Espécie destinada a\n" +
    ...
    OCA("Ordem do Comando da Aeronáutica", "Espécie de caráter determinativo\n" +
    ...
    PCA("Plano do Comando da Aeronáutica", "Espécie de caráter determinativo\n" +
            ...
            "específico"),
    RCA("Regulamento do Comando da Aeronáutica", "Espécie de caráter\n" +
    ...
    RICA("Regimento Interno do Comando da Aeronáutica", "Espécie destinada a\n" +
            ...
            "Organização"),
    ROCA("Regulamento de Organização do Comando da Aeronáutica", "É a espécie\n" +
    ...
    TCA("Tabela do Comando da Aeronáutica", "Espécie destinada a registrar,\n" +
    ...
    DocumentationTypeEnum(String name, String description) {
        this.name = name;
